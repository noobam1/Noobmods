...
async def start(update: Update, context: CallbackContext):
    ...
    message = (
        ...
        "*💬 Owner: @NOOB_AM*\n"
        "*📢 Channel: [NOOB_AM_VIP Channel](https://t.me/NOOB_AM_VIP)*"
    )
...
async def help_command(update: Update, context: CallbackContext):
    chat_id = update.effective_chat.id
    message = (
        "*❓ How to Use the NOOB AM DDOS Bot?*\n\n"
        "*🔑 Commands:*\n\n"
...
async def attack(update: Update, context: CallbackContext):
    ...
    if user_id not in users:
        await context.bot.send_message(chat_id=chat_id, text="*🤡 You need to get permission to use this bot. Contact owner @NOOB_AM.*", parse_mode='Markdown')
        return
